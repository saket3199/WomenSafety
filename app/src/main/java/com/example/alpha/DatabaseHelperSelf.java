...
public class DatabaseHelperSelf extends SQLiteOpenHelper {

    //id for this row is today's date

    public static final String DATABASE_NAME="SelfRegistration.db";
    ...
    public DatabaseHelperSelf(@Nullable Context context) {
